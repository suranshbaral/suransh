			...
			>
				...
				<div>
					<h1 className={`${styles.heroHeadText} text-white relative z-10`}>
						Hi, I'm <span className='text-clr_blue'>Suransh</span>
					</h1>
					<p
						className={`${styles.heroSubText} relative z-10 mt-2 text-white-100 md:max-w-[640px] max-w-[460px] `}
					>
						Dynamic and results-oriented Computer Engineer with extensive experience in full-stack development, machine learning, and integrating complex systems for impactful solutions.
					</p>
				</div>
			</div>
