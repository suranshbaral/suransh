...
const Contact = () => {
	...
	const serviceID = 'service_dtw4imu';
	const templateID = 'template_5jsv8eg';
	const publicKey = 'O_82i48l2_nLkz5vJ';
	const toName = 'Suransh Baral'; // Replace with actual recipient name
